...
local AutoFarmRarityDropdown = tab:CreateDropdown({
    name = "Target Rarity",
    multiSelect = true,
    options = {"Common", "Water", "Rare", "Epic", "Ghost", "Legendary", "67", "Mythic", "Secret", "Slime God", "Rainbow", "Exclusive", "OG", "Moon", "Candy", "Galaxy", "Toxic Waste", "Beach"},
                ...
                while AutoFarmEnabled do
                    ...
                    for _, slime in slimes:GetChildren() do
                        ...
                        if contains(selectedRarity, rarity) then
                            ...
                            if root then
                                getHRP().CFrame = slime.PrimaryPart.CFrame
                                task.wait(0.2)
